...
| :---- | :---- | :---- |
| **Frontend Framework** | **Next.js 16+ (App Router)** | เป็นมาตรฐานใหม่ของ React โหลดเร็ว ทำ SEO ได้ดีเยี่ยม (สำคัญสำหรับงานประกวด) |
...
| **UI Components** | **shadcn/ui (Tailwind v4)** | คอมโพเนนต์แบบ copy-paste (Button, Input, Label, Card, etc) ใช้ธีม Neutral + สี Wellness (เขียว/ทอง) |
...
1. **User Input:** ผู้สมัครกรอกฟอร์ม \+ อัปโหลดรูป (ครึ่งตัว/เต็มตัว) \+ อัปโหลดสลิป  500 บาท
